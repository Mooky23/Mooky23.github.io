...
看右边:
![](https://raw.githubusercontent.com/qiubaiying/qiubaiying.github.io/master/img/luke-stackpoole-mStq-dtsXCQ-unsplash.jpeg
...
sidebar-avatar: /img/luke-stackpoole-mStq-dtsXCQ-unsplash.jpeg     #你的大头贴，请使用绝对地址.注意：名字区分大小写！后缀名也是
```
